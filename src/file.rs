...
// fn  read_cfg_line (char *str, int max_size, FILE *fp)
// {
// 	char *s;
...
// fn  read_scanner_config_file (char *filename)
// {
// 	FILE *fp;
// 	char str[256];
...
// fn checksum (unsigned char *block) -> i16
// {
// 	int acc,carry;
// 	int i;
...
// fn save_commander_file (path: &str) -> i16
// {
// 	FILE *fp;
